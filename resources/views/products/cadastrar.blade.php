...
@section('content')
    ...
    <section class="formulario">
        <div class="pagina">
            ...
            <div class="rota">
                <a href="{{ route('menu') }}">Menu</a> / <a href="{{ route('produtos') }}"> Produtos</a> / Cadastrar
            </div>
        </div>
        <form action="{{ route('enviaCadastroProduto') }}" class="row" method="post" enctype="multipart/form-data">
            @csrf
